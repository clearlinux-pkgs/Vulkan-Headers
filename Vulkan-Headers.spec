...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.238/Vulkan-Headers-1.3.238.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.238
cd %{_builddir}/Vulkan-Headers-1.3.238
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671482114
mkdir -p clr-build
pushd clr-build
