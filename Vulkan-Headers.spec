...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.233/Vulkan-Headers-1.3.233.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.233
cd %{_builddir}/Vulkan-Headers-1.3.233
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667499983
mkdir -p clr-build
pushd clr-build
