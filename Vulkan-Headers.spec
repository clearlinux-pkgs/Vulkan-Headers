...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.241/Vulkan-Headers-1.3.241.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.241
cd %{_builddir}/Vulkan-Headers-1.3.241
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676567607
mkdir -p clr-build
pushd clr-build
