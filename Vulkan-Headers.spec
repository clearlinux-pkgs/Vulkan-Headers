...
Version  : 1.4.307
Release  : 205
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.307/Vulkan-Headers-1.4.307.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.307/Vulkan-Headers-1.4.307.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.307
cd %{_builddir}/Vulkan-Headers-1.4.307
pushd ..
cp -a Vulkan-Headers-1.4.307 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.307 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738267592
mkdir -p clr-build
pushd clr-build
