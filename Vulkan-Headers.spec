...
Version  : 1.3.250
Release  : 152
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.250/Vulkan-Headers-1.3.250.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.250/Vulkan-Headers-1.3.250.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.250
cd %{_builddir}/Vulkan-Headers-1.3.250
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683219359
mkdir -p clr-build
pushd clr-build
