...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.223/Vulkan-Headers-1.3.223.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.223
cd %{_builddir}/Vulkan-Headers-1.3.223
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659022074
mkdir -p clr-build
pushd clr-build
