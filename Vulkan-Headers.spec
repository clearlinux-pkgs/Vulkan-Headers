...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.228/Vulkan-Headers-1.3.228.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.228
cd %{_builddir}/Vulkan-Headers-1.3.228
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663258768
mkdir -p clr-build
pushd clr-build
