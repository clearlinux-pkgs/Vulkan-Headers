...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.234/Vulkan-Headers-1.3.234.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.234
cd %{_builddir}/Vulkan-Headers-1.3.234
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668099319
mkdir -p clr-build
pushd clr-build
