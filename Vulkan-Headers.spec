...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.230/Vulkan-Headers-1.3.230.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.230
cd %{_builddir}/Vulkan-Headers-1.3.230
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664466405
mkdir -p clr-build
pushd clr-build
