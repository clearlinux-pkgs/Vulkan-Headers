...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.303/Vulkan-Headers-1.4.303.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.303
cd %{_builddir}/Vulkan-Headers-1.4.303
pushd ..
cp -a Vulkan-Headers-1.4.303 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.303 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733164192
mkdir -p clr-build
pushd clr-build
