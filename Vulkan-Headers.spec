...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.249/Vulkan-Headers-1.3.249.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.249
cd %{_builddir}/Vulkan-Headers-1.3.249
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682612737
mkdir -p clr-build
pushd clr-build
