...
Version  : 1.4.319
Release  : 215
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.319/Vulkan-Headers-1.4.319.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.319/Vulkan-Headers-1.4.319.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.319
cd %{_builddir}/Vulkan-Headers-1.4.319
pushd ..
cp -a Vulkan-Headers-1.4.319 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.319 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750432730
mkdir -p clr-build
pushd clr-build
