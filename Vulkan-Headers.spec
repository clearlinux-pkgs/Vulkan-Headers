...
Version  : 1.3.240
Release  : 142
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.240/Vulkan-Headers-1.3.240.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.240/Vulkan-Headers-1.3.240.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.240
cd %{_builddir}/Vulkan-Headers-1.3.240
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674753741
mkdir -p clr-build
pushd clr-build
