...
Version  : 1.3.274
Release  : 173
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.274/Vulkan-Headers-1.3.274.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.274/Vulkan-Headers-1.3.274.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.274
cd %{_builddir}/Vulkan-Headers-1.3.274
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703278307
mkdir -p clr-build
pushd clr-build
