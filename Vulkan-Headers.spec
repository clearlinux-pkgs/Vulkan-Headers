...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.284/Vulkan-Headers-1.3.284.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.284
cd %{_builddir}/Vulkan-Headers-1.3.284
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715022515
mkdir -p clr-build
pushd clr-build
