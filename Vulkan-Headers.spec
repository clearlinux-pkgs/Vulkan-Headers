...
Version  : 1.4.306
Release  : 204
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.306/Vulkan-Headers-1.4.306.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.306/Vulkan-Headers-1.4.306.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.306
cd %{_builddir}/Vulkan-Headers-1.4.306
pushd ..
cp -a Vulkan-Headers-1.4.306 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.306 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737731777
mkdir -p clr-build
pushd clr-build
