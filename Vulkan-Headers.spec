...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.239/Vulkan-Headers-1.3.239.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.239
cd %{_builddir}/Vulkan-Headers-1.3.239
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674152607
mkdir -p clr-build
pushd clr-build
