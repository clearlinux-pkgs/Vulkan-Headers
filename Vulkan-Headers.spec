...
Version  : 1.3.232
Release  : 133
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.232/Vulkan-Headers-1.3.232.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.232/Vulkan-Headers-1.3.232.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.232
cd %{_builddir}/Vulkan-Headers-1.3.232
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666881907
mkdir -p clr-build
pushd clr-build
