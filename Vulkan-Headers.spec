...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.275/Vulkan-Headers-1.3.275.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.275
cd %{_builddir}/Vulkan-Headers-1.3.275
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704472338
mkdir -p clr-build
pushd clr-build
