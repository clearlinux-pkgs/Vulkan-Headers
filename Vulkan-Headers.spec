...
Version  : 1.3.293
Release  : 189
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.293/Vulkan-Headers-1.3.293.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.293/Vulkan-Headers-1.3.293.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.293
cd %{_builddir}/Vulkan-Headers-1.3.293
pushd ..
cp -a Vulkan-Headers-1.3.293 build32
popd
pushd ..
cp -a Vulkan-Headers-1.3.293 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723820063
mkdir -p clr-build
pushd clr-build
