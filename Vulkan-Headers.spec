...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.269/Vulkan-Headers-1.3.269.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.269
cd %{_builddir}/Vulkan-Headers-1.3.269
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697827529
mkdir -p clr-build
pushd clr-build
