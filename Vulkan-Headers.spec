...
Version  : 1.3.251
Release  : 153
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.251/Vulkan-Headers-1.3.251.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.251/Vulkan-Headers-1.3.251.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.251
cd %{_builddir}/Vulkan-Headers-1.3.251
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685407359
mkdir -p clr-build
pushd clr-build
