...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.243/Vulkan-Headers-1.3.243.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.243
cd %{_builddir}/Vulkan-Headers-1.3.243
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678728663
mkdir -p clr-build
pushd clr-build
