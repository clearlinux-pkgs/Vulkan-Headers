...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.285/Vulkan-Headers-1.3.285.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.285
cd %{_builddir}/Vulkan-Headers-1.3.285
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715631831
mkdir -p clr-build
pushd clr-build
