...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.226/Vulkan-Headers-1.3.226.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.226
cd %{_builddir}/Vulkan-Headers-1.3.226
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662051753
mkdir -p clr-build
pushd clr-build
