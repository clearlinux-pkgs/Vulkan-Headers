...
Version  : 1.3.280
Release  : 179
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.280/Vulkan-Headers-1.3.280.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.280/Vulkan-Headers-1.3.280.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.280
cd %{_builddir}/Vulkan-Headers-1.3.280
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709916233
mkdir -p clr-build
pushd clr-build
