...
Version  : 1.3.283
Release  : 182
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.283/Vulkan-Headers-1.3.283.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.283/Vulkan-Headers-1.3.283.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.283
cd %{_builddir}/Vulkan-Headers-1.3.283
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713546796
mkdir -p clr-build
pushd clr-build
