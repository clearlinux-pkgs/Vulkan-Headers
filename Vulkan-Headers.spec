...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.278/Vulkan-Headers-1.3.278.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.278
cd %{_builddir}/Vulkan-Headers-1.3.278
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708102941
mkdir -p clr-build
pushd clr-build
