...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.312/Vulkan-Headers-1.4.312.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.312
cd %{_builddir}/Vulkan-Headers-1.4.312
pushd ..
cp -a Vulkan-Headers-1.4.312 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.312 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743781617
mkdir -p clr-build
pushd clr-build
