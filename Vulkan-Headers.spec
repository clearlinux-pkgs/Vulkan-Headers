...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.281/Vulkan-Headers-1.3.281.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.281
cd %{_builddir}/Vulkan-Headers-1.3.281
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711247019
mkdir -p clr-build
pushd clr-build
