...
Version  : 1.3.298
Release  : 194
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.298/Vulkan-Headers-1.3.298.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.298/Vulkan-Headers-1.3.298.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.298
cd %{_builddir}/Vulkan-Headers-1.3.298
pushd ..
cp -a Vulkan-Headers-1.3.298 build32
popd
pushd ..
cp -a Vulkan-Headers-1.3.298 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728664570
mkdir -p clr-build
pushd clr-build
