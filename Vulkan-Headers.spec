...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.294/Vulkan-Headers-1.3.294.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.294
cd %{_builddir}/Vulkan-Headers-1.3.294
pushd ..
cp -a Vulkan-Headers-1.3.294 build32
popd
pushd ..
cp -a Vulkan-Headers-1.3.294 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724420264
mkdir -p clr-build
pushd clr-build
