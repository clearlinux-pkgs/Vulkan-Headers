...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.260/Vulkan-Headers-1.3.260.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.260
cd %{_builddir}/Vulkan-Headers-1.3.260
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690557754
mkdir -p clr-build
pushd clr-build
