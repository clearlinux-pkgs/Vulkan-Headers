...
Version  : 1.4.315
Release  : 212
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.315/Vulkan-Headers-1.4.315.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.315/Vulkan-Headers-1.4.315.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.315
cd %{_builddir}/Vulkan-Headers-1.4.315
pushd ..
cp -a Vulkan-Headers-1.4.315 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.315 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746800526
mkdir -p clr-build
pushd clr-build
