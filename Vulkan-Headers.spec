...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.305/Vulkan-Headers-1.4.305.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.305
cd %{_builddir}/Vulkan-Headers-1.4.305
pushd ..
cp -a Vulkan-Headers-1.4.305 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.305 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737130561
mkdir -p clr-build
pushd clr-build
