...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.282/Vulkan-Headers-1.3.282.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.282
cd %{_builddir}/Vulkan-Headers-1.3.282
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713138120
mkdir -p clr-build
pushd clr-build
