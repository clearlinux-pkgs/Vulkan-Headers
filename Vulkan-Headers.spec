...
Version  : 1.3.279
Release  : 178
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.279/Vulkan-Headers-1.3.279.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.279/Vulkan-Headers-1.3.279.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.279
cd %{_builddir}/Vulkan-Headers-1.3.279
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709330984
mkdir -p clr-build
pushd clr-build
