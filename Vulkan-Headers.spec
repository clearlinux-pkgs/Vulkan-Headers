...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.247/Vulkan-Headers-1.3.247.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.247
cd %{_builddir}/Vulkan-Headers-1.3.247
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681408855
mkdir -p clr-build
pushd clr-build
