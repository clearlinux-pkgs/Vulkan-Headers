...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.235/Vulkan-Headers-1.3.235.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.235
cd %{_builddir}/Vulkan-Headers-1.3.235
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668703468
mkdir -p clr-build
pushd clr-build
