...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.231/Vulkan-Headers-1.3.231.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.231
cd %{_builddir}/Vulkan-Headers-1.3.231
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665694800
mkdir -p clr-build
pushd clr-build
