...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.227/Vulkan-Headers-1.3.227.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.227
cd %{_builddir}/Vulkan-Headers-1.3.227
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662662967
mkdir -p clr-build
pushd clr-build
