...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.225/Vulkan-Headers-1.3.225.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.225
cd %{_builddir}/Vulkan-Headers-1.3.225
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660849407
mkdir -p clr-build
pushd clr-build
