...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.299/Vulkan-Headers-1.3.299.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.299
cd %{_builddir}/Vulkan-Headers-1.3.299
pushd ..
cp -a Vulkan-Headers-1.3.299 build32
popd
pushd ..
cp -a Vulkan-Headers-1.3.299 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729261045
mkdir -p clr-build
pushd clr-build
