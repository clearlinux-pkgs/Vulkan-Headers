...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.248/Vulkan-Headers-1.3.248.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.248
cd %{_builddir}/Vulkan-Headers-1.3.248
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682024251
mkdir -p clr-build
pushd clr-build
