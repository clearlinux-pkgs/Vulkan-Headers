...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.224/Vulkan-Headers-1.3.224.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.224
cd %{_builddir}/Vulkan-Headers-1.3.224
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659649764
mkdir -p clr-build
pushd clr-build
