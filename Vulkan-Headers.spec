...
Version  : 1.3.253
Release  : 155
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.253/Vulkan-Headers-1.3.253.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.253/Vulkan-Headers-1.3.253.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.253
cd %{_builddir}/Vulkan-Headers-1.3.253
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686589866
mkdir -p clr-build
pushd clr-build
