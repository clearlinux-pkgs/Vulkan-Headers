...
Version  : 1.3.252
Release  : 154
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.252/Vulkan-Headers-1.3.252.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.252/Vulkan-Headers-1.3.252.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.252
cd %{_builddir}/Vulkan-Headers-1.3.252
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685723047
mkdir -p clr-build
pushd clr-build
