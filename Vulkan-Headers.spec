...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.242/Vulkan-Headers-1.3.242.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.242
cd %{_builddir}/Vulkan-Headers-1.3.242
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677520113
mkdir -p clr-build
pushd clr-build
