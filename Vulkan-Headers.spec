...
Version  : 1.4.314
Release  : 211
URL      : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.314/Vulkan-Headers-1.4.314.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.4.314/Vulkan-Headers-1.4.314.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.4.314
cd %{_builddir}/Vulkan-Headers-1.4.314
pushd ..
cp -a Vulkan-Headers-1.4.314 build32
popd
pushd ..
cp -a Vulkan-Headers-1.4.314 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746454859
mkdir -p clr-build
pushd clr-build
