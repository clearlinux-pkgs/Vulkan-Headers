...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.229/Vulkan-Headers-1.3.229.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.229
cd %{_builddir}/Vulkan-Headers-1.3.229
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663864650
mkdir -p clr-build
pushd clr-build
