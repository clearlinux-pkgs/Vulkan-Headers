...
Source0  : https://github.com/KhronosGroup/Vulkan-Headers/archive/v1.3.270/Vulkan-Headers-1.3.270.tar.gz
...
%prep
%setup -q -n Vulkan-Headers-1.3.270
cd %{_builddir}/Vulkan-Headers-1.3.270
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699904216
mkdir -p clr-build
pushd clr-build
